...
class Crawler:
    ...
    def __getImages(self, word='word'):
        ...
        while pn < self.amount:
            ...
            url = 'http://image.baidu.com/search/avatarjson?tn=resultjsonavatarnew&ie=utf-8&word=' + search + '&cg=&pn=' + str(
    ...
    def __saveImage(self, json, word):
        ...
        for info in json['imgs']:
            try:
                ...
                print("image+1,已有" + str(counter) + "张image")
                counter += 1
        return
